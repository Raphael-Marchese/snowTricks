...
final class Version20241128135321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if (!in_array('message', $existingTables)) {
            ...
            $this->addSql(
                'ALTER TABLE figure ADD CONSTRAINT FK_2F57B37AF675F31B FOREIGN KEY (author_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE'
            );
            $this->addSql(
            ...
            $this->addSql(
                'ALTER TABLE message ADD CONSTRAINT FK_B6BD307F5C011B5 FOREIGN KEY (figure_id) REFERENCES figure (id) NOT DEFERRABLE INITIALLY IMMEDIATE'
            );
        }
        }
